...
export default function ManageBlogs() {
  ...
  return (
    <div className="p-10 pl-65 bg-gray-100 min-h-screen">
          ...
          <tbody>
            {currentBlogs.map((blog) => (
              <tr key={blog.id} className="border-b">
                <td className="pt-10 pb-10 pl-2 pr-2">
                  <Image
                    src={blog.image}
                    alt={blog.title}
                    width={120}
                ...
                <td className="p-2 pt-12 flex gap-2">
                  <button className="text-blue-600 hover:text-blue-800 text-1xl">
                    <FaEye />
                  </button>
                  <button className="text-green-600 hover:text-green-800 text-1xl">
                    <FaEdit />
                  </button>
                  <button className="text-red-600 hover:text-red-800 text-1xl">
                    <FaTrash />
                  </button>
                </td>
              </tr>
