...
const ServiceThirdHoverEffect = () => {
  return (
    <div className="elementor-element elementor-element-e1da1a0 e-con-full e-flex e-con e-parent e-lazyloaded" data-id="e1da1a0" data-element_type="container">
		<div className="elementor-element elementor-element-0d56b5d e-con-full e-flex e-con e-child" data-id="0d56b5d" data-element_type="container">
				<div className="elementor-element elementor-element-1e074a5 elementor-widget elementor-widget-projects" data-id="1e074a5" data-element_type="widget" data-widget_type="projects.default">
				<div className="elementor-widget-container">
					
        
            <section className="tp-featured__2-area fix black-bg p-relative pt-110 pb-125">
                                    <div className="tp-featured__2-shape-1">
                        <img decoding="async" src="https://etorisoft.com/wp/avtrix/wp-content/uploads/2024/09/featured-2-1-shape.png" alt=""/>
                    </div>
                                <div className="tp-featured__2-shape-2">
                    <span>
                        <svg width="55" height="59" viewBox="0 0 55 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M54.5 40.5027L29.1858 29.4836L54.2022 18.4645L50.3306 11.4658L28.1434 27.9945L31.1216 0H23.3784L26.3566 27.9945L4.1694 11.4658L0.297814 18.4645L25.3142 29.4836L0 40.5027L4.1694 47.2036L26.3566 30.6749L23.3784 58.9672H31.1216L28.1434 30.6749L50.3306 47.2036L54.5 40.5027Z" fill="currentColor"></path>
                        </svg>
                    </span>
                </div>
...
export default ServiceThirdHoverEffect
